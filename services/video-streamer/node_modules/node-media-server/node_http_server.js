...
const WebSocket = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/ws');
const Express = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/express');
const bodyParser = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/body-parser');
const basicAuth = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/basic-auth-connect');
const NodeFlvSession = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_flv_session');
const HTTP_PORT = 80;
const HTTPS_PORT = 443;
const HTTP_MEDIAROOT = './media';
const Logger = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_logger');
const context = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_ctx');

const streamsRoute = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/api/routes/streams');
const serverRoute = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/api/routes/server');
const relayRoute = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/api/routes/relay');
