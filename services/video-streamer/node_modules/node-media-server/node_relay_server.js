...
const NodeCoreUtils = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_utils');
const NodeRelaySession = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_relay_session');
...
const { getFFmpegVersion, getFFmpegUrl } = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_utils');
const fs = require('fs');
const _ = require('node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_modules/lodash');
