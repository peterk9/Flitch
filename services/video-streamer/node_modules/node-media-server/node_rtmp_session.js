...
const AV = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_av");
const { AUDIO_SOUND_RATE, AUDIO_CODEC_NAME, VIDEO_CODEC_NAME } = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_av");

const AMF = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_amf");
const Handshake = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_rtmp_handshake");
const NodeCoreUtils = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_utils");
const NodeFlvSession = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_flv_session");
const context = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_ctx");
const Logger = require("node-media-server/node_modules/node-media-server/node_modules/node-media-server/node_core_logger");
